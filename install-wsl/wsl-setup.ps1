...
if($setup){
    ...
    wsl -d $distro --exec bash -c "cd; rm -rf dev_setup; git clone https://github.com/13janderson/dev_setup; cd dev_setup; rm -r install-wsl;"
    wsl -d $distro --exec bash -c "cd wsl/init/docker/$distro; bash ./install-docker.sh"
